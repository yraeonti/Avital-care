    ...
    return (
        <section className="px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <AnalyticsCard title="Doctors" figure={2} bg="bg-[#f7e1d7]" icon={<Stethoscope className="stroke-[#a9491d]" />} />
                <AnalyticsCard title="Patients" figure={2} bg="bg-[#d0f4de]" icon={<User2 className="stroke-[#1ea351]" />} />
