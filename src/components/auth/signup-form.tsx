...
const ProfileDetails = ({
  ...
  return (
    <div className="py-20">
      <Form {...profileForm}>
        <form
          onSubmit={profileForm.handleSubmit(onNextClick)}
        ...
        >
          ...
          <div className="font-extralight mt-5 flex justify-center space-x-2">
            ...
            <Link
              href="/login"
              className="font-semibold hover:scale-110 active:scale-90 transitio-all ease-in-out"
            >
              Login
            </Link>
          </div>
      ...
      <Form {...userForm}>
        ...
        >
          ...
          <div className="flex justify-center mt-10 space-x-3">
            <Button
              type="button"
              className="w-full active:scale-95 hover:scale-105 transition-all ease-in-out active:duration-75"
              disabled={isLoading}
              onClick={() => pageTo && setpage(pageTo)}
            >
              Back
            </Button>
            <Button
          ...
          <div className="font-extralight mt-5 flex justify-center space-x-2">
            ...
            <Link
              href="/login"
              className="font-semibold hover:scale-110 active:scale-90 transition-all ease-in-out active:duration-75"
            >
              Login
            </Link>
          </div>
